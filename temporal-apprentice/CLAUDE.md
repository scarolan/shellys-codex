...
- `temporal_apprentice.z5` — compiled Z-machine story file (generated by the compiler)
...
```bash
inform6 +/usr/local/share/inform6/lib/ temporal_apprentice.inf temporal_apprentice.z5
```
...
```bash
/usr/games/dfrotz temporal_apprentice.z5
```
